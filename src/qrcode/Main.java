...
public class Main {
	...
	public static void main(String[] args) {
		...
		Mat srcImg=Imgcodecs.imread("G:/ImgaeTest/QRA1.jpg");
		double scale=0.2;
		Size size = new Size(srcImg.cols()*scale, srcImg.rows()*scale);
		 Imgproc.resize(srcImg, srcImg, size,0,0,Imgproc.INTER_CUBIC);
		 SrcIMG=srcImg.clone();
